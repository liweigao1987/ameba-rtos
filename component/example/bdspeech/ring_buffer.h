...
#ifndef AMEBA_APPLICATION_UTILS_INCLUDE_UTILS_RINGBUFFER_H
#define AMEBA_APPLICATION_UTILS_INCLUDE_UTILS_RINGBUFFER_H
...
#endif // AMEBA_APPLICATION_UTILS_INCLUDE_UTILS_RINGBUFFER_H
